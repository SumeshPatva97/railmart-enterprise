        ...
        {loading ? (
          ...
          <>
            ...
            <div className="text-center mt-12">
              <Link
                href="/products"
                className="inline-flex items-center gap-2.5 bg-gradient-to-r from-railway-600 to-amber-500 hover:from-railway-500 hover:to-amber-400 text-white font-extrabold text-sm px-8 py-3.5 rounded-2xl shadow-xl shadow-railway-600/30 hover:scale-105 active:scale-95 transition-all duration-300 border border-amber-400/30 group"
              >
