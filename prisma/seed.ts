...
async function main() {
  ...
  await prisma.blog.create({
    data: {
      title: 'Modernizing Track Maintenance with Hydraulic Rail Benders',
      slug: 'modernizing-track-maintenance-hydraulic-rail-benders',
      excerpt: 'Learn how 100-Ton hydraulic benders reduce track downtime and improve joint alignment precision.',
      content: `Track alignment is vital to high-speed rail safety. Modern hydraulic rail benders provide field engineers with the portability and exact tonnage required to align UIC 60 and 52kg rails effortlessly.`,
      coverImage: 'https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=800&q=80',
      author: 'Er. Amit Sharma',
      tags: 'Track Maintenance, Hydraulic Tools, Engineering',
    },
  });

  // 8. Create CRM Leads & Tickets
